package com.example.spingcloudeurekazuul2;

import com.example.spingcloudeurekazuul2.filter.GatewayFilter;
...
public class SpingCloudEurekaZuul2Application {
    ...
    public static void main(String[] args) {
        SpringApplication.run(SpingCloudEurekaZuul2Application.class, args);
    }
}
