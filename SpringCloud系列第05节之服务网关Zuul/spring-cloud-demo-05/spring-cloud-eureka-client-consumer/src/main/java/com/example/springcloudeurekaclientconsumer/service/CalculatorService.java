package com.example.springcloudeurekaclientconsumer.service;
...
@FeignClient(value = "sping-cloud-eureka-zuul", fallback = CalculatorService.HystrixCalculatorService.class)
